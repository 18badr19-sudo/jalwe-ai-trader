...
class OptionsEngine:
    ...
    def score_option_contract(self, contract_data: dict) -> dict:
        """
        Scores and filters option contracts based on liquidity, spread, DTE, Delta, and IV safely.
        ...
        try:
            ...
            if spread > 0.50 or volume < 10 or open_interest < 100:
                return {
                    "score": 0.0, 
                    "approved": False, 
                    "reason": "Poor liquidity or wide spread"
                }
            ...
            logging.error(f"Error scoring option contract: {e}")
            return {
                "score": 0.0, 
                "approved": False, 
...
def evaluate_option(contract_data: dict) -> dict:
    try:
        ...
        logging.error(f"Error in evaluate_option helper: {e}")
        return {
            "score": 0.0, 
            "approved": False, 
